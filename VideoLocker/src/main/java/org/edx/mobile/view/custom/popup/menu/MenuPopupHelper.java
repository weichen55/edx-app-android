...
class MenuPopupHelper implements AdapterView.OnItemClickListener, View.OnKeyListener,
    ...
    private final int mPopupListDividerHeight;
    ...
    public MenuPopupHelper(Context context, MenuBuilder menu, View anchorView,
        ...
        mPopupListDividerHeight = a.getDimensionPixelOffset(
                R.styleable.PopupMenu_android_dividerHeight, 0);
    ...
    private enum ItemType {
        HEADER(R.layout.popup_menu_header),
        ITEM(R.layout.popup_menu_item);

        final int mLayoutRes;

        ItemType(@LayoutRes int layoutRes) {
    ...
    private class MenuAdapter extends BaseAdapter {
        ...
        public boolean isEnabled(int position) {
            return getItemType(position) != ItemType.HEADER &&
                    getItem(position).isEnabled();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            textView.setPadding(mPopupPadding, position > 0 ?
                    mPopupListDividerHeight : mPopupPadding, mPopupPadding,
                    position < getCount() - 1 ? mPopupListDividerHeight : mPopupPadding);
            return textView;
        }
    }
}
